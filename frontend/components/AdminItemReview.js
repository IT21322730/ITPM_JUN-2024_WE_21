...
function AdminReview() {
    ...
    const getCount5Rating = () => {
      axios
        .get(`http://localhost:8070/Item/Item/${id}/5reviewscount`)
        .then((res) => {
    ...
    const getCount4Rating = () => {
      axios
        .get(`http://localhost:8070/Item/Item/${id}/4reviewscount`)
        .then((res) => {
    ...
    const getCount3Rating = () => {
      axios
        .get(`http://localhost:8070/Item/Item/${id}/3reviewscount`)
        .then((res) => {
    ...
    const getCount2Rating = () => {
      axios
        .get(`http://localhost:8070/Item/Item/${id}/2reviewscount`)
        .then((res) => {
    ...
    const getCount1Rating = () => {
      axios
        .get(`http://localhost:8070/Item/Item/${id}/1reviewscount`)
        .then((res) => {
  ...
  return (
    <div style={{marginLeft:"30px"}}>
      ...
      <div className="columnRA2">
        <p><i class="fa fa-circle" style={{color:"#0747B8"}}></i> All Reviews : &nbsp;&nbsp;&nbsp;{inputs.numReviews}</p>
        <p><i class="fa fa-circle" style={{color:"#0747B8"}}></i> Average Rating : &nbsp;&nbsp;&nbsp;{inputs.avgRating?.toFixed(1)}</p>
        <p><span class="fa fa-star checked" style={{color:'#07B82A'}}/> 5 Star : &nbsp;&nbsp;&nbsp;{count5Rating}</p>
        <p><span class="fa fa-star checked" style={{color:'#00E831'}}/> 4 Star : &nbsp;&nbsp;&nbsp;{count4Rating}</p>
        <p><span class="fa fa-star checked" style={{color:'#FEE700'}}/> 3 Star : &nbsp;&nbsp;&nbsp;{count3Rating}</p>
        <p><span class="fa fa-star checked" style={{color:'#FE7F00'}}/> 2 Star : &nbsp;&nbsp;&nbsp;{count2Rating}</p>
        <p><span class="fa fa-star checked" style={{color:'#CB0802'}}/> 1 Star: &nbsp;&nbsp;&nbsp;{count1Rating}</p>
      </div>
